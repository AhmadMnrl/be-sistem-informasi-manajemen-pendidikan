  ...
  paths: {
    ...
    "/api/students": {
      get: {
        ...
        responses: {
          200: {
            description: "OK",
            content: { "application/json": { example: { status: 200, message: "Data siswa berhasil diambil", success: true, data: { items: [{ id: 1, name: "Alya Putri", identifier: "STU-001" }], totalItems: 1, page: 1, pageSize: 5, totalPages: 1 } } } },
          },
        },
      },
      post: {
    ...
    "/api/students/{id}": {
      get: {
        ...
        security: [{ bearerAuth: [] }],
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "integer" }, example: 1 }],
        responses: { 200: { description: "OK", content: { "application/json": { example: { status: 200, message: "Data siswa berhasil diambil", success: true, data: { id: 1, name: "Alya Putri", identifier: "STU-001", className: "A1", tahunAjaran: "2025/2026" } } } } }, 404: { description: "Siswa tidak ditemukan" } },
      },
      put: {
        tags: ["Students"],
        summary: "Ubah siswa",
    ...
    "/api/reports/{id}": {
      get: {
        ...
        security: [{ bearerAuth: [] }],
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "integer" }, example: 1 }],
          responses: { 200: { description: "OK", content: { "application/json": { example: { status: 200, message: "Data rapor berhasil diambil", success: true, data: { id: 1, title: "Perkembangan Bulanan April", studentId: 1 } } } } }, 404: { description: "Rapor tidak ditemukan" } },
      },
      put: {
        tags: ["Reports"],
        summary: "Ubah rapor",
    ...
    "/api/documents": {
      get: {
        ...
        responses: { 200: { description: "OK", content: { "application/json": { example: { status: 200, message: "Data dokumen berhasil diambil", success: true, data: { items: [{ id: 1, title: "Laporan Mutu 2022", filePath: "/uploads/documents/laporan.pdf" }], totalItems: 1, page: 1 } } } } },
      },
      post: {
        tags: ["Documents"],
    ...
    "/api/documents/{id}": {
      get: {
        ...
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "integer" }, example: 1 }],
        responses: { 200: { description: "OK" } },
        responses: { 201: { description: "OK", content: { "application/json": { example: { status: 201, message: "Dokumen berhasil dibuat", success: true, data: { id: 10, title: "Laporan Akreditasi 2026", filePath: "/uploads/documents/laporan-akreditasi.pdf" } } } } } },
      put: {
        tags: ["Documents"],
    ...
    "/api/questions": {
      get: {
        responses: { 200: { description: "OK", content: { "application/json": { example: { status: 200, message: "Data dokumen berhasil diambil", success: true, data: { id: 1, title: "Laporan Mutu 2022", filePath: "/uploads/documents/laporan.pdf", documentDate: "2022-06-01" } } } } }, 404: { description: "Dokumen tidak ditemukan" } },
      ...
      post: {
        responses: { 200: { content: { "application/json": { example: { status: 200, message: "Dokumen berhasil diperbarui", success: true, data: { id: 1, title: "Laporan Mutu 2022" } } } } }, 404: { description: "Dokumen tidak ditemukan" } },
